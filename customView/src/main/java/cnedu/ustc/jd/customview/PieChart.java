...
*/
package cnedu.ustc.jd.customview;
...
public class PieChart extends ViewGroup {
     ...
     *                {@link com.ustc.jd5737.customview.R.styleable.PieChart} as well as attributes inherited
     *                from {@link View}.
     */
    public PieChart(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                com.ustc.jd5737.customview.R.styleable.PieChart,
                0, 0
        );
        ...
        try {
            ...
            mShowText = a.getBoolean(com.ustc.jd5737.customview.R.styleable.PieChart_showText, false);
            mTextY = a.getDimension(com.ustc.jd5737.customview.R.styleable.PieChart_labelY, 0.0f);
            mTextWidth = a.getDimension(com.ustc.jd5737.customview.R.styleable.PieChart_labelWidth, 0.0f);
            mTextHeight = a.getDimension(com.ustc.jd5737.customview.R.styleable.PieChart_labelHeight, 0.0f);
            mTextPos = a.getInteger(com.ustc.jd5737.customview.R.styleable.PieChart_labelPosition, 0);
            mTextColor = a.getColor(com.ustc.jd5737.customview.R.styleable.PieChart_labelColor, 0xff000000);
            mHighlightStrength = a.getFloat(com.ustc.jd5737.customview.R.styleable.PieChart_highlightStrength, 1.0f);
            mPieRotation = a.getInt(com.ustc.jd5737.customview.R.styleable.PieChart_pieRotation, 0);
            mPointerRadius = a.getDimension(com.ustc.jd5737.customview.R.styleable.PieChart_pointerRadius, 2.0f);
            mAutoCenterInSlice = a.getBoolean(com.ustc.jd5737.customview.R.styleable.PieChart_autoCenterPointerInSlice, false);
        } finally {
    ...
    private void init() {
        ...
        if (this.isInEditMode()) {
            ...
            addItem("Annabelle", 3, res.getColor(com.ustc.jd5737.customview.R.color.bluegrass));
            addItem("Brunhilde", 4, res.getColor(com.ustc.jd5737.customview.R.color.chartreuse));
            addItem("Carolina", 2, res.getColor(com.ustc.jd5737.customview.R.color.emerald));
            addItem("Dahlia", 3, res.getColor(com.ustc.jd5737.customview.R.color.seafoam));
            addItem("Ekaterina", 1, res.getColor(com.ustc.jd5737.customview.R.color.slate));
        }
