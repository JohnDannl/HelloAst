...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ustc.jd5737.helloworld.R.layout.activity_main);
        mContext=this;
        viewContainer=(LinearLayout) findViewById(com.ustc.jd5737.helloworld.R.id.adaptive_view_container);
        EditText searchView=(EditText) LayoutInflater.from(this).inflate(com.ustc.jd5737.helloworld.R.layout.et_add_sub_view,null);
        ...
        final Button btn_add=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_add_view);
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv=(TextView)LayoutInflater.from(mContext).inflate(com.ustc.jd5737.helloworld.R.layout.tv_add_sub_view,null);
                tv.setText(getString(com.ustc.jd5737.helloworld.R.string.btn_prefix,addedViews.size()+1));
                viewContainer.addView(tv,addedViews.size());
                addedViews.add(tv);
            }
        });
        Button btn_rm=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_rm_view);
        ...
        final Button btn_rotate=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_rotate);
        ...
        Button btn_toast=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_toast);
        ...
        final Button btn_anim1=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_anim_1);
        final Button btn_anim2=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_anim_2);
        final Button btn_anim3=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_anim_3);
        final LinearLayout animContainer = (LinearLayout)findViewById(com.ustc.jd5737.helloworld.R.id.anim_container);
...
//        scale.setRepeatCount(Animation.INFINITE);
        ...
        Button btnToViewPager=(Button)findViewById(com.ustc.jd5737.helloworld.R.id.btn_to_view_pager);
        ...
        findViewById(com.ustc.jd5737.helloworld.R.id.ll_text_view_container).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
