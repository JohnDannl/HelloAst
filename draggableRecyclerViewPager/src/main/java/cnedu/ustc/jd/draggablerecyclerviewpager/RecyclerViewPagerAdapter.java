...
import cnedu.ustc.jd.draggablerecyclerviewpager.widget.DraggableItemTouchHelperAdapter;
...
public class RecyclerViewPagerAdapter extends RecyclerView.Adapter<RecyclerViewPagerAdapter.ItemViewHolder> implements DraggableItemTouchHelperAdapter {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(final View itemView, int viewType) {
            super(itemView);
            textView = (TextView) itemView.findViewById(com.ustc.jd5737.draggablerecyclerviewpager.R.id.info_text);
    ...
    public RecyclerViewPagerAdapter(Context context) {
        ...
        for (int i = 0; i < 13; i++) {
            mItems.add(new Item(i + 1, "Item " + (i + 1), com.ustc.jd5737.draggablerecyclerviewpager.R.drawable.ic_launcher));
        }
    }
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_NORMAL) {
            itemView = LayoutInflater.from(parent.getContext()).inflate(com.ustc.jd5737.draggablerecyclerviewpager.R.layout.recycler_view_item_normal, parent, false);
            itemViewHolder = new ItemViewHolder(itemView, viewType);
            itemViewHolder.textView = (TextView) itemView.findViewById(com.ustc.jd5737.draggablerecyclerviewpager.R.id.info_text);
        } else if (viewType == TYPE_FOOTER){
            itemView = LayoutInflater.from(parent.getContext()).inflate(com.ustc.jd5737.draggablerecyclerviewpager.R.layout.recycler_view_item_footer, parent, false);
            itemViewHolder = new ItemViewHolder(itemView, viewType);
            itemViewHolder.textView = (TextView) itemView.findViewById(com.ustc.jd5737.draggablerecyclerviewpager.R.id.info_text);
        }
